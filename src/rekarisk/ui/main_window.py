...
# Mixin modules for calculations and MC/sensitivity/batch handlers
from .calculations import CalculationMixin
from .mc_handlers import MCHandlerMixin
...
class MainWindow(CalculationMixin, MCHandlerMixin, QMainWindow):
